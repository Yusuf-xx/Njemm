    ...
    <AnimatePresence>
      {isModalOpen ? (
        ...
        >
          ...
          >
            <h3 className="font-display text-2xl text-brandTealDark">Continue your booking in the NJEMM App</h3>
            <p className="mt-2 text-sm text-slate-600">For secure checkout and live inventory, finish your journey inside the NJEMM mobile experience.</p>
